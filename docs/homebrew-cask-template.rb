...
cask "duometer" do
  ...
  url "https://github.com/wasakunset/duometer/releases/download/v#{version}/Duometer.zip"
  name "Duometer"
  desc "Claude and Codex rate limits in the menu bar"
  homepage "https://github.com/wasakunset/duometer"
  ...
  zap trash: [
    "~/Library/Preferences/com.wasakunset.duometer.plist",
  ]
end
